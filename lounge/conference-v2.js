(() => {
  ...
  function start({profile,mount,callbacks={}}){
    ...
    state.api=new JitsiMeetExternalAPI(DOMAIN,{roomName:ROOM,parentNode:mount,width:'100%',height:'100%',lang:'ja',userInfo:{displayName:profile.nickname},configOverwrite:{prejoinPageEnabled:false,disableDeepLinking:true,startWithAudioMuted:true,startWithVideoMuted:false,enableWelcomePage:false,enableClosePage:false,disableInviteFunctions:true,subject:'日本語で話そう！ · Duan Learning',toolbarButtons:['microphone','camera','desktop','chat','participants-pane','raisehand','reactions','tileview','settings','hangup','fullscreen','select-background','videoquality','filmstrip','shortcuts','closedcaptions']},interfaceConfigOverwrite:{MOBILE_APP_PROMO:false,SHOW_JITSI_WATERMARK:false,SHOW_BRAND_WATERMARK:false,TILE_VIEW_MAX_COLUMNS:5}});bind();
  }
